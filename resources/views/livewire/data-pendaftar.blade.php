                ...
                @foreach ($listUser as $key => $user)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-slate-300">
                        ...
                        <td class="py-4 px-6 flex space-x-3 items-center">
                            <a href="{{ route('admin.detail-pendaftar',[ 'user' => $user->slug ]) }}"  class=" border-2 border-emerald-400 p-2 rounded-md bg-emerald-400 text-white hover:bg-emerald-500 hover:border-emerald-500 focus:border-emerald-600" role="button">Detail</a>
