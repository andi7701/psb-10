<div class="container flex flex-col flex-wrap items-center justify-between px-1 mx-auto md:flex-row">
    <div class="flex flex-col items-center justify-center w-full pt-24 text-center lg:items-start md:w-2/5 md:text-left">
        ...
        <p class="mb-3 leading-normal text-sm lg:text-xl">
            Tahun Pelajaran 2023 / 2024
        </p>
        <p class="mb-3 leading-normal text-sm lg:text-xl text-left">
            - Pendaftaran Offline Gelombang 3 dibuka setiap hari Sekolah pukul 07.30 - 12.30 WIB

            <br>

            - Untuk pendaftaran online Gelombang 3 silahkan klik tombol Daftar di bawah

            <br>
            - Tes Seleksi Gelombang 3 di laksanakan di Kampus SMP Al Musyaffa pada tanggal 26 Mei dan 2 Juni 2023

            Mulai pukul 7.30 - 13.00 WIB
