<section id="profil" class="py-8 bg-white border-b">
        ...
        <div class="flex flex-col flex-wrap sm:flex-row justify-center items-center">
            <div class="w-full p-6 mt-6 sm:w-1/2">
                <div class="align-middle">
                    <h3
                        class="p-2 mb-2 text-xl font-bold leading-none text-center text-white bg-emerald-700 border-2  rounded-br-lg border-emerald-700">
                        VIDEO PROFIL
                    ...
                    <iframe class="w-full" width="560" height="315"
                        src="https://www.youtube.com/embed/_TIzV0JM5hE" title="YouTube video player"
                        frameborder="0"
