    ...
    <div class="container max-w-5xl m-8 mx-auto">
        <div class="flex flex-col flex-wrap sm:flex-row">
            <div class="w-full p-6 mt-6 sm:w-1/2">
                <img src="images/beasiswa.png" alt="syarat" />
            </div>
            <div class="w-full p-6 mt-6 sm:w-1/2">
                <div class="align-middle">
                    ...
                    <div class="mb-5">
                        ...
                        <span
                            class="p-1 font-bold text-yellow-400 border-b-2 rounded-lg border-emerald-700 bg-emerald-700">
                            BEASISWA
                            <span class="text-white">NON-AKADEMIK</span>
                        </span>
                    </div>
                    <div class="mb-5">
                        <span
                    ...
                    <div class="mb-5">
                        ...
                        <span
                            class="p-1 font-bold text-yellow-400 border-b-2 rounded-lg border-emerald-700 bg-emerald-700">
                            BEASISWA
                            <span class="text-white">TIDAK MAMPU</span>
                        </span>
                    </div>
                    <div class="mb-5">
                        <span
                        ...
                        <span
                            class="p-1 font-bold text-yellow-400 border-b-2 rounded-lg border-emerald-700 bg-emerald-700">
                            BEASISWA
                            <span class="text-white">PEMERINTAH</span>
                        </span>
                    </div>
                    <div>
                        <span
                        ...
                        <span
                            class="p-1 font-bold text-yellow-400 border-b-2 rounded-lg border-emerald-700 bg-emerald-700">
                            BEASISWA
                            <span class="text-white">KAKAK BERADIK</span>
                        </span>
                    </div>
                </div>
            </div>
