...
class QuestionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        [
            ...
            [
                'priority' => 2,
                'body' => '	2.	Ari mempunyai 2 lembar uang seribuan dan 6 koin seratusan dan Santi mempunyai 3 lembar uang seribuan dan 7 koin seratusan. Jumlah uang Ari dan Santi adalah...',
                'answers' => json_encode(['Rp. 6.300','Rp. 7.300', 'Rp. 7.700', 'Rp. 8.300']),
                'correct' => 0
            ],
            [
                'priority' => 3,
                'body' => '	3.	Ahmad memiliki kelereng yang disimpan di 4 toples miliknya, setiap toples berisi 75 kelereng. Ahmad mengambil 15 kelereng dari masing-masing toples untuk diberikan kepada teman-temannya. Sisa kelereng yang dimiliki Ahmad adalah ….',
                'answers' => json_encode([60,240,285,300]),
                'correct' => 1
            ],
            [
                'priority' => 4,
                'body' => '	4.	Data pengunjung perpustakaan sekolah pada bulan November 2022 disajikan dalam diagram batang di atas, berdasarkan diagram batang di atas, selisih pengunjung pada minggu kedua dan minggu kelima adalah …. Orang',
            ...
            [
                ...
                'answers' => json_encode(['Kapan kak Rio bisa bermain bola professional?',
            ...
            [
                'priority' => 9,
                'body' => '	4.	Sejak kelas I sampai kelas VI SD, Anisa selalu menjadi … . Dia tak pernah absen untuk menerima hadiah prestasi yang diberikan kepala sekolah. Ungkapan yang tepat untuk melengkapi kalimat tersebut adalah… ',
                'answers' => json_encode(['Buah bibir','Besar kepala', 'Bintang kelas', 'Kabar burung']),
                'correct' => 2
            ],
            [
                'priority' => 10,
                'body' => '	5.	Pertandingan sepakbola antara PSS dan Persebaya berakhir dengan kemenangan oleh Persebaya. Suasana permainan sangat hidup. Para pendukung telah membanjiri Stadion Maguwoharjo sebelum pertandingan dimulai. Mereka saling menjaga satu sama lain, sehingga tidak ada banyak keributan sampai pertandingan selesai. Arti kata pendukung dalam paragraf adalah… .',
                'answers' => json_encode(['Reporter', 'Proyektor', 'Provokator', 'Supporter']),
                'correct' => 3
            ],
            [
                'priority' => 11,
                'body' => '	1.	One, Two, ... , Four, Five.',
